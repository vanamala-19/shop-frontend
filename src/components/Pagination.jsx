  ...
  return (
    <div className="flex items-center justify-center">
      ...
      <button
        onClick={() => current(0)}
        disabled={page === 0}
        className="flex items-center justify-center px-3 h-8 mr-3 text-sm font-medium text-gray-500  border border-gray-300 rounded-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
        First Page
      </button>
      <button
        onClick={previous}
