...
const AddUser = () => {
  ...
  return (
    <div className="dark:bg-dark dark:text-white bg-light text-dark flex max-w-2xl mx-auto shadow border-b">
      <div className="px-8 py-8">
        ...
        <div className="items-center justify-center h-14 w-full my-4">
          ...
          <input
            ...
            name="custName"
            value={user.custName}
            className="dark:bg-dark dark:text-white bg-light text-dark h-10 w-96 border mt-2 px-2 py-2"></input>
        </div>
        <div className="items-center justify-center h-14 w-full my-4">
          <label className="block dark:text-white text-gray-600 text-sm font-normal">
            Email:
